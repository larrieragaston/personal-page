	...
	return (
		<section id="courses">
			...
			<div className="exp-all">
				<div className="courses-each left firstelement">
				...
				<div className="courses-each right">
					<div className="exp-title">
						<h3>{t("std2_title")}</h3>
				...
				<div className="courses-each left">
					<div className="exp-title">
						<h3>{t("std3_title")}</h3>
...
export default translate("courses-section")(CoursesSection);
