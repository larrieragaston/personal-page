		...
		<section id="experience">
			...
			<div className="exp-all">
				<div className="exp-each left firstelement">
					...
					<p className="bajada">{t("wxp1_position")}</p>
				...
				<div className="exp-each right">
					...
					<p className="bajada">{t("wxp2_position")}</p>
				...
				<div className="exp-each left">
					...
					<p className="bajada">{t("wxp3_position")}</p>
				...
				<div className="exp-each right">
					...
					<p className="bajada">{t("wxp4_position")}</p>
				...
				<div className="exp-each left">
					...
					<p className="bajada">{t("wxp5_position")}</p>
				...
				<div className="exp-each right">
					...
					<p className="bajada">{t("wxp6_position")}</p>
